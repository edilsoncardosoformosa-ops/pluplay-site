...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInJlZiI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5xaHRoeXBlbGp1cGZmdGxtd3N6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTc2ODIwNzcsImV4cCI6MjA3MzI1ODA3N30.4JcgkPqt-yMrCLNdP65nQL99xyhDs2DrgR-C-CrT4z4';
...
async function startQuiz(blocoKey) {
    ...
    try {
        let { data: questoes, error } = await supabase
            .from(userType==='demo' ? 'questoes_demo' : 'questoes')
            .select('*')
